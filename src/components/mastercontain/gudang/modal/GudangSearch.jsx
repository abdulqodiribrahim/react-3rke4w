...
class GudangSearch extends Component{
    constructor(props) {
        super(props);
    }
            ...
            <>
                <Modal
                    ...
                    title={
                        ...
                        >
                            {/*Tittle Modal */}
                            <div className="title">Cari Gudang <hr className="titleHR"/></div>
                ...
                >
                    ...
                    <div className={"row backModal"}>
                        ...
                        <div className={"col-3"}>
                            <Checkbox onChange={""}>Default Gudang</Checkbox>
                        </div>
                    </div>
                    {/*Nama*/}
                    <div className={"row backModal"}>
