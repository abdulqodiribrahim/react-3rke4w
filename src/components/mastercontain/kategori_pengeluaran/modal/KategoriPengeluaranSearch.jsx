...
class KategoriPengeluaranSearch extends Component{
    constructor(props) {
        super(props);
    }
            ...
            <>
                <Modal
                    ...
                    title={
                        ...
                        >
                            {/*Tittle Modal */}
                            <div className="title">Search Kategori Pengeluaran<hr className="titleHR"/></div>
...
export default KategoriPengeluaranSearch;