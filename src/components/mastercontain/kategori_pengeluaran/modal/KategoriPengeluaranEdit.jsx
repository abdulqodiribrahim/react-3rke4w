...
class KategoriPengeluaranEdit extends Component{
    constructor(props) {
        super(props);
    }
            ...
            <>
                <Modal
                    ...
                    title={
                        ...
                        >
                            {/*Tittle Modal */}
                            <div className="title">Edit Kategori Pengeluaran<hr className="titleHR"/></div>
...
export default KategoriPengeluaranEdit;