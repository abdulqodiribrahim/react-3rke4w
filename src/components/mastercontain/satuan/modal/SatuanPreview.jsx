...
export class SatuanPreview extends Component{
    columns = [
        {
            title: 'No',
            dataIndex: 'no',
    ...
    render() {
        return(
            <div className="row" style={{padding: "15px"}}>
                ...
                {/*Title Preview*/}
                <div className="col-4">
                    <h4 style={{paddingTop: "15px", textAlign: "center"}}>Daftar Satuan</h4>
                </div>
                {/*Table*/}
                <div className="col-12">
                    <Table
                        ...
                        pagination={{ pageSize: SatuanData.length, position: ['none', 'none']}}
                    />
                </div>
            </div>
        )
