...
class ReturnPembelianSearchTable2 extends Component{
    constructor(props) {
        super(props);
    }
            ...
            <>
                <Modal
                    ...
                    title={
                        ...
                        >
                            {/*Tittle Modal */}
                            <div className="title">Cari Return Pembelian <hr className="titleHR"/></div>
...
export default ReturnPembelianSearchTable2;