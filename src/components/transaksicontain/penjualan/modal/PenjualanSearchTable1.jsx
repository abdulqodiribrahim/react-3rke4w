...
class PenjualanSearchTable1 extends Component{
    constructor(props) {
        super(props);
    }
            ...
            <>
                <Modal
                    ...
                    title={
                        ...
                        >
                            {/*Tittle Modal */}
                            <div className="title">Cari Transaksi Penjualan <hr className="titleHR"/></div>
...
export default PenjualanSearchTable1;