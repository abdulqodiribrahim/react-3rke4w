...
class BayarHutangSupplierEdit extends Component{
    constructor(props) {
        super(props);
    }
            ...
            <>
                <Modal
                    ...
                    title={
                        ...
                        >
                            {/*Tittle Modal */}
                            <div className="title">Edit Bayar Hutang Supplier<hr className="titleHR"/></div>
...
export default BayarHutangSupplierEdit;