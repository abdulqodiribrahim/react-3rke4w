...
class PembelianSearchTable1 extends Component{
    constructor(props) {
        super(props);
    }
            ...
            <>
                <Modal
                    ...
                    title={
                        ...
                        >
                            {/*Tittle Modal */}
                            <div className="title">Cari Transaksi Pembelian <hr className="titleHR"/></div>
                                ...
                                <div className="row backModal">
                                    ...
                                    <div className="col-4">
                                        <div className={"inputContain"}>
                                            ...
                                            >
                                                <Option value="free">Nota Cash</Option>
...
export default PembelianSearchTable1;
